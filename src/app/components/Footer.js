...
<div className='flex items-center border-b-2 px-3 justify-between'><input type='email' placeholder='ENTER YOUR EMAIL'  className='border-0 px-1 bg-transparent'/><FaRegEnvelope className='text-xl'/></div>
